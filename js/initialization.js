...
function createProduct() {
    if (localStorage.getItem('products') == null) {
        ...
        },
        {
            ...
            category: 'Món mặn',
            price: 130000,
            desc: 'Cá chiên ngon là ở độ giòn rụm của cá mà vẫn giữ được độ mềm ẩm của thịt bên trong'
        },
        {
            id: 21,
            status: 1, 
        ...
        },
        {
            id: 61,
            status: 1, 
            title: 'Trà tắc thái xanh',
            img: './assets/img/products/tra-thai-xanh.jpg',
            category: 'Nước uống',
            price: 20000,
            desc: 'mát'
        },
...
function createAdminAccount() {
    ...
    if (!accounts) {
        accounts = [];
        accounts.push({
            fullname: "Chu Ngọc Hoàng",
            phone: "0839979176",
            password: "123456789",
            address: '',
            email: 'ngochoang17@gmail.com',
            status: 1,
            join: new Date(),
            cart: [],
            userType: 1
